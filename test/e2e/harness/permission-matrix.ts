...
export const DENIED_PERMISSION_CASES: DeniedPermissionCase[] = [
  ...
  },
  {
    ...
    method: 'get',
    path: (seed) => `/item-categories/${seed.itemCategoryA.id}`,
    permission: 'itemCategories.read',
    query: enterpriseAQuery,
  },
  {
  ...
  },
  {
    ...
    query: enterpriseAQuery,
    body: (seed) => ({ name: 'Intruso empleado', itemCategoryId: seed.itemCategoryA.id }),
  },
  {
    name: 'GET /items/:id',
    method: 'get',
    path: (seed) => `/items/${seed.itemA.id}`,
    permission: 'items.read',
    query: enterpriseAQuery,
  },
  {
  ...
  },
  {
    name: 'GET /orders/:id',
    method: 'get',
    path: (seed) => `/orders/${seed.orderA.id}`,
    permission: 'orders.read',
  },
  {
  ...
  },
  {
    ...
    method: 'patch',
    path: (seed) => `/orders/${seed.orderA.id}/status`,
    permission: 'orders.write',
    query: (seed) => ({ ...enterpriseAQuery(seed), status: 'received' }),
  },
  {
