/**
 * Transformador TypeORM para columnas `numeric` del artículo.
 * El driver de PostgreSQL suele devolver `numeric` como string; la API trabaja con `number`.
 */
export const itemNumericAmountTransformer = {
  /**
